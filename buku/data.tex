...
This study proposes a new formal definition of collective movement pattern that aims to fix the previous problems from existing formal definitions by making use of trajectory direction and \textit{dynamic time warping} algorithm. Quantitative and qualitative analysis on real-life pedestrian trajectory datasets show that} 
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{lintasan, pergerakan kolektif, \textit{arah}, \textit{kecepatan}}
...
\begin{enumerate}
    ...
    \item Bapak Lionov Wiratma yang mengajar dan membimbing penulis dalam proses pengerjaan skripsi dan memberikan ilmu-ilmu yang tidak bisa penulis dapatkan dalam perkuliahan biasa.
    \item Samuel dan Gunawan yang menjadi senior yang baik selama penulis berkuliah di Universitas Katolik Parahyangan serta memberikan dukungan pada penulis dalam berbagai bentuk.
    ...
    \item Tokopedia yang telah memberikan kesempatan beasiswa kepada penulis.
\end{enumerate}
