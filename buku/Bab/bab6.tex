...
\begin{enumerate}
    ...
    \begin{figure}[b!]
        \centering
        \includegraphics[height=6cm]{Gambar/bab6:contoh-eth.pdf}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.25\textwidth}
        \centering
        \includegraphics[height=5.75cm]{Gambar/bab6:masalah-veiig-batu-1.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.275\textwidth}
        \centering
        \includegraphics[height=5.75cm]{Gambar/bab6:masalah-veiig-batu-2.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.25\textwidth}
        \centering
        \includegraphics[height=5.75cm]{Gambar/bab6:masalah-veiig-batu-3.pdf}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[h]{0.235\textwidth}
        \centering
        \includegraphics[height=7cm]{Gambar/bab6:solusi-kecepatan-veiig-1.pdf}
    \end{subfigure}
    \begin{subfigure}[h]{0.235\textwidth}
        \centering
        \includegraphics[height=7cm]{Gambar/bab6:solusi-kecepatan-veiig-2.pdf}
    \end{subfigure}
