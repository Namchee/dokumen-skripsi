...
\begin{enumerate}
    ...
    \begin{figure}[b!]
        \centering
        \includegraphics[height=8.15cm]{Gambar/bab6:contoh-eth.pdf}
...
\begin{figure}[b!]
    ...
    \includegraphics[width=0.55\textwidth]{Gambar/bab6:dua-arah.pdf}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.275\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-eth-1.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.275\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-eth-2.pdf}
    \end{subfigure}
...
\begin{figure}[h]
    \centering
    \captionsetup{width=0.6\textwidth}
    \includegraphics[height=3cm]{Gambar/bab6:masalah-eth-ketat.pdf}
...
\begin{figure}[b!]
    ...
    \begin{subfigure}[h]{0.15\textwidth}
        \centering
        \includegraphics[height=7cm]{Gambar/bab6:masalah-eth-n.pdf}
    \end{subfigure}
    \begin{subfigure}[h]{0.15\textwidth}
        \centering
        \includegraphics[height=7cm]{Gambar/bab6:masalah-eth-n-2.pdf}
    \end{subfigure}
