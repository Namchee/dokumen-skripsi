...
\begin{figure}[h]
    ...
    \includegraphics[width=0.825\textwidth]{Gambar/bab6:contoh-visualisasi.pdf}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.175\textwidth}
        \centering
        \includegraphics[height=8.5cm]{Gambar/bab6:masalah-eth-n.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.175\textwidth}
        \centering
        \includegraphics[height=8.5cm]{Gambar/bab6:masalah-eth-n-2.pdf}
    \end{subfigure}
...
\begin{figure}[t!]
    ...
    \begin{subfigure}[t]{0.25\textwidth}
        \centering
        \includegraphics[height=6.25cm]{Gambar/bab6:masalah-veiig-batu-1.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.275\textwidth}
        \centering
        \includegraphics[height=6.25cm]{Gambar/bab6:masalah-veiig-batu-2.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.25\textwidth}
        \centering
        \includegraphics[height=6.25cm]{Gambar/bab6:masalah-veiig-batu-3.pdf}
    \end{subfigure}
...
\begin{figure}[t!]
    ...
    \begin{subfigure}[b]{0.265\textwidth}
        \centering
        \includegraphics[height=8cm]{Gambar/bab6:solusi-kecepatan-veiig-1.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.265\textwidth}
        \centering
        \includegraphics[height=8cm]{Gambar/bab6:solusi-kecepatan-veiig-2.pdf}
    \end{subfigure}
