...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.25\textwidth]{Gambar/bab6:entitas.pdf}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.6\textwidth]{Gambar/bab6:contoh-visualisasi.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[height=5.25cm]{Gambar/bab6:masalah-eth-1.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[height=5.25cm]{Gambar/bab6:masalah-eth-2.pdf}
    \end{subfigure}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.225\textwidth}
        \centering
        \includegraphics[height=8.25cm]{Gambar/bab6:masalah-eth-n.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.225\textwidth}
        \centering
        \includegraphics[height=8.25cm]{Gambar/bab6:masalah-eth-n-2.pdf}
    \end{subfigure}
...
\begin{figure}[b]
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        \centering
        \includegraphics[height=5.5cm]{Gambar/bab6:masalah-veiig-arah-1.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.25\textwidth}
        \centering
        \includegraphics[height=5.5cm]{Gambar/bab6:masalah-veiig-arah-2.pdf}
    \end{subfigure}
...
\begin{figure}[b]
    ...
    \begin{subfigure}[b]{0.225\textwidth}
        \centering
        \includegraphics[height=6cm]{Gambar/bab6:solusi-kecepatan-veiig-1.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.225\textwidth}
        \centering
        \includegraphics[height=6cm]{Gambar/bab6:solusi-kecepatan-veiig-2.pdf}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[h]{0.225\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-cbe-1.pdf}
    \end{subfigure}
    \begin{subfigure}[h]{0.225\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-cbe-2.pdf}
    \end{subfigure}
    \begin{subfigure}[h]{0.225\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-cbe-3.pdf}
    \end{subfigure}
