...
\begin{figure}[t]
    \centering
    \captionsetup{width=0.8\textwidth}
    \includegraphics[height=11.25cm]{Gambar/bab3:beda-arah-lokal.pdf}
...
\begin{figure}[t]
    \centering
    \captionsetup{width=0.8\textwidth}
    \includegraphics[width=0.95\textwidth]{Gambar/bab3:beda-kecepatan.pdf}
...
\begin{figure}[t]
    ...
    \includegraphics[width=0.625\textwidth]{Gambar/bab3:contoh-algoritma-identifikasi.pdf}
