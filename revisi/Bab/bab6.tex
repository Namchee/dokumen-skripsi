...
Visualisasi hasil identifikasi rombongan yang dihasilkan oleh perangkat lunak pada video rekaman pergerakan pejalan kaki dilakukan dengan bantuan perangkat lunak visualisasi yang dibuat oleh Wiratma, dkk~\cite{wiratma:software} dan Maurice Marx\footnotemark[1]. Perangkat lunak tersebut menerima masukan berupa rekaman video pergerakan, rekaman data lintasan, hasil identifikasi manusia, dan hasil identifikasi dari perangkat lunak identifikasi rombongan. Perangkat lunak visualisasi kemudian akan menghasilkan video rekaman sumber data yang telah dimodifikasi di mana seluruh entitas yang terdapat dalam video rekaman asli akan ditandai menggunakan figur yang telah ditunjukkan melalui Gambar~\ref{bab2:entitas}.

\footnotetext[1]{\url{https://github.com/marximus/trackviz}}

\begin{figure}[h!]
    \centering
    \captionsetup{width=0.85\textwidth}
    \includegraphics[width=0.9\textwidth]{Gambar/bab6:contoh-visualisasi.pdf}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[htbp]{0.2\textwidth}
        \centering
        \includegraphics[height=9cm]{Gambar/bab6:masalah-eth-n.pdf}
    \end{subfigure}
    \begin{subfigure}[htbp]{0.2\textwidth}
        \centering
        \includegraphics[height=9cm]{Gambar/bab6:masalah-eth-n-2.pdf}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.225\textwidth}
        \centering
        \includegraphics[height=5.625cm]{Gambar/bab6:masalah-veiig-batu-1.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.25\textwidth}
        \centering
        \includegraphics[height=5.625cm]{Gambar/bab6:masalah-veiig-batu-2.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.225\textwidth}
        \centering
        \includegraphics[height=5.625cm]{Gambar/bab6:masalah-veiig-batu-3.pdf}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[htbp]{0.235\textwidth}
        \centering
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[htbp]{0.365\textwidth}
        \centering
