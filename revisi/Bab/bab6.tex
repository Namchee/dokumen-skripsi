...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.275\textwidth}
        \centering
        \includegraphics[height=7cm]{Gambar/bab6:masalah-veiig-arah-1.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.275\textwidth}
        \centering
        \includegraphics[height=7cm]{Gambar/bab6:masalah-veiig-arah-2.pdf}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.2\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-veiig-batu-1.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.225\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-veiig-batu-2.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.2\textwidth}
        \centering
        \includegraphics[height=5cm]{Gambar/bab6:masalah-veiig-batu-3.pdf}
    \end{subfigure}
