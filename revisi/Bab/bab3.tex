...
\begin{figure}[t]
    ...
    \includegraphics[width=0.435\textwidth]{Gambar/bab3:contoh-algoritma-identifikasi.pdf}
...
\begin{figure}[t]
    \centering
    \captionsetup{width=0.7\textwidth}
    \includegraphics[width=\textwidth]{Gambar/bab3:contoh-algoritma-redundansi.pdf}
