...
\begin{figure}[h]
    ...
    \begin{subfigure}[h]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=10cm]{Gambar/bab1:koi.jpg}
        \caption{Kumpulan ikan koi dalam kolam yang memiliki pergerakan kolektif\protect\footnotemark[6]}
        \label{bab1:koi}
    \end{subfigure} \hspace{0.5cm}
    \begin{subfigure}[h]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=10cm]{Gambar/bab1:ped.jpg}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[h]{0.225\textwidth}
        \centering
        \includegraphics[height=6.5cm]{Gambar/bab1:beda-kecepatan-1.pdf}
    \end{subfigure}
    \begin{subfigure}[h]{0.225\textwidth}
        \centering
        \includegraphics[height=6.5cm]{Gambar/bab1:beda-kecepatan-2.pdf}
    \end{subfigure}
    \begin{subfigure}[h]{0.225\textwidth}
        \centering
        \includegraphics[height=6.5cm]{Gambar/bab1:beda-kecepatan-3.pdf}
    \end{subfigure}
...
\footnotetext[9]{\url{https://github.com/marximus/trackviz}}
