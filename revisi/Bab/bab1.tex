...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{Gambar/bab1:sumber-data.png}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[h]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=11.5cm]{Gambar/bab1:koi.jpg}
        \caption{Kumpulan ikan koi dalam kolam yang memiliki pergerakan kolektif\protect\footnotemark[6]}
        \label{bab1:koi}
    \end{subfigure} \hspace{0.25cm}
    \begin{subfigure}[h]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=11.5cm]{Gambar/bab1:ped.jpg}
