...
\begin{table}[h!]
    ...
    \begin{tabular}{|m{4cm}|l|p{8.5cm}|} 
        \hline
        \multirow{5}{*}{
            \includegraphics[width=2.65cm]{Gambar/bab2:jumlah.pdf}
        } & Nama & Jumlah entitas \\ 
        \cline{2-3}
...
Karena dapat dimanfaatkan pada berbagai bidang, identifikasi pola pergerakan kolektif menjadi topik penelitian yang hangat pada bidang komputasi geometri. Berikut merupakan beberapa contoh dari definisi formal pergerakan kolektif yang sudah ada:
...
\begin{itemize}
    ...
    \begin{figure}[h]
        ...
        \includegraphics[width=0.625\textwidth]{Gambar/bab2:flock.pdf}
    ...
    \begin{figure}[h]
        \centering
        \captionsetup{width=0.75\textwidth}
        \includegraphics[width=\textwidth]{Gambar/bab2:group.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Gambar/bab2:proksemik.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35\textwidth]{Gambar/bab2:entitas.pdf}
