...
Karena dapat dimanfaatkan pada berbagai bidang, identifikasi pergerakan kolektif menjadi topik penelitian yang hangat pada bidang komputasi geometri. Berikut merupakan beberapa contoh dari definisi formal pergerakan kolektif yang sudah ada:
...
\begin{itemize}
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=0.6\textwidth]{Gambar/bab2:flock.pdf}
    ...
    \begin{figure}[htbp]
        \centering
        \captionsetup{width=0.75\textwidth}
        \includegraphics[width=0.9\textwidth]{Gambar/bab2:group.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{Gambar/bab2:proksemik.pdf}
...
\begin{figure}[b!]
    \centering
    \includegraphics[width=0.3\textwidth]{Gambar/bab2:entitas.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{Gambar/bab2:contoh-visualisasi.pdf}
